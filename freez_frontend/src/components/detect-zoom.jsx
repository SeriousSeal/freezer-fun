 ...
 * Updated for JSX by https://github.com/SeriousSeal/
 */
...
const detectZoom = (function () {
	...
	*/
    ...
    // Main function that returns the zoom info
    return function() {
        // Try each browser's zoom detection method
        if (typeof window.outerWidth !== 'undefined') {
            ...
            return firefox4();
        } else if (typeof screen.deviceXDPI !== 'undefined') {
            return ie8();
